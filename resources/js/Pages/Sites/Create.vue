...
const suggestUser = () => {
    if (!form.system_user && form.domain) {
        ...
        const name = form.domain.split('.')[0].toLowerCase().replace(/[^a-z0-9]/g, '');
    ...
    <AppLayout>
        <div class="max-w-2xl mx-auto space-y-6">
            <div class="flex items-center gap-4">
                <Link :href="route('servers.sites.index', server.id)" class="btn btn-circle btn-ghost btn-sm">
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div class="form-control">
                            ...
                            <input
                                ...
                                @blur="suggestUser"
                            />
                            <div v-if="form.errors.domain" class="text-error text-xs mt-1">
                                {{ form.errors.domain }}
                            </div>
                        </div>
                        ...
                        <div class="form-control">
                            <label class="label">
                                ...
                                <span class="label-text-alt">Isolated Linux user for this site</span>
                            </label>
                            <input
                                ...
                                class="input input-bordered"
                                :class="{ 'input-error': form.errors.system_user }"
                            />
                            <div v-if="form.errors.system_user" class="text-error text-xs mt-1">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <select v-model="form.app_type" class="select select-bordered">
                                    <option value="generic">Generic PHP / HTML</option>
                                    <option value="wordpress">WordPress</option>
                                    <option value="laravel">Laravel</option>
                                </select>
                                <div v-if="form.errors.app_type" class="text-error text-xs mt-1">
                            ...
                            <div class="form-control">
                                ...
                                <select v-model="form.php_version" class="select select-bordered">
