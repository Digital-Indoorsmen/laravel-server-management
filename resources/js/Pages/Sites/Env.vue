    ...
    <AppLayout>
        <div class="space-y-6">
            <div class="flex items-center gap-4">
                <Link :href="route('sites.show', site.id)" class="btn btn-circle btn-ghost btn-sm">
            ...
            <div class="card bg-base-100 border border-base-300 shadow-sm">
                <div class="card-body">
                    <div class="alert alert-warning text-sm shadow-sm mb-4">
                        ...
                        <span>Be careful! Invalid configuration can break your site. Secrets are stored securely on the server.</span>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        <div class="form-control">
                            <textarea
                                ...
                                spellcheck="false"
                            ></textarea>
                            <div v-if="form.errors.content" class="text-error text-xs mt-1">
                                {{ form.errors.content }}
                            </div>
                        </div>
