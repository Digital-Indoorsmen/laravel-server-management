    ...
    >
        <div class="w-full max-w-5xl grid gap-6 lg:grid-cols-2">
            ...
            >
                <div class="space-y-6">
                    <div
                        class="inline-flex items-center gap-2 rounded-full bg-primary/10 px-4 py-2 text-primary"
                    >
                        <ShieldCheckIcon class="h-5 w-5" />
                        <span
                            class="text-xs font-semibold uppercase tracking-[0.2em]"
                            >Laravel Server Manager</span
                        >
                    </div>
                    ...
                    <p class="text-base-content/70">
                        Sign in with the panel admin account created by the
                        installer to manage servers, keys, sites, and deployment
                        diagnostics.
                    </p>
                </div>
                ...
                <div class="card-body p-8 sm:p-10">
                    <div class="mb-6 space-y-2">
                        ...
                        <p class="text-sm text-base-content/60">
                            Authenticate to continue to the server management
                            dashboard.
                        </p>
                    </div>
